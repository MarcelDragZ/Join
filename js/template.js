...
/**
 * returns the template for a task
 *
 * @param {string} i - index of the category
 * @param {string} test - right task array from the array
 * @param {string} finishedSubTasks - all subtasks
 */
function taskTemplate(i, test, finishedSubTasks) {
    ...
    <h4>${test.title}</h4>
    <p id="task-title" class="grey">${test.description}</p>
...
/**
 * returns the template for a contact at a task
 *
 * @param {string} contactColor - color of the contact
 * @param {string} bothFirstLetter - first to letters of the contact name
 ...
 * returns the template for a contact at a task
 *
 * @param {string} letter - contact name first letter
 * @param {string} i - index of the contact
 */
...
/**
 * returns the template for a contact at a task when opened detailed
 *
 * @param {string} contactColor - color of the contact
 * @param {string} bothFirstLetter - first to letters of the contact name
 * @param {string} contactName - contact name
...
/**
 * opens the container of the contact shown detailes
 *
 * @param {string} contactColor - color of the contact
 * @param {string} bothFirstLetter - first to letters of the contact name
 * @param {string} contactName - contact name
 ...
 * returns the template for a contact at a task
 *
 * @param {string} contact - contact thats in the task
 * @param {string} test - is the task
 * @param {string} i - index of the contact
 */
...
/**
 * the task that you want to edit
 *
 * @param {string} test - is the task
 * @param {string} i - index of the contact
 */
